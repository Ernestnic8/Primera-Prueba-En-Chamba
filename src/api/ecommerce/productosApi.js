...
const modificarStock = (id, data) => axios.put(`http://localhost:13052/api/Producto/ActualizarStock/${id}`, data);

const categoriasApi =()=> axios.get("http://localhost:13052/api/Categoria/Lista");

export { categoriasApi ,obtenerProductos,modificarStock , nuevoProducto, actualizarProducto, eliminarProducto };